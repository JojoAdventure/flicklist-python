...
class CrossOffMovie(webapp2.RequestHandler):
    ...
    def post(self):
        removie = self.request.get("removie")

        removie_element = "<strong>" + removie + "</strong>"
        sentence = removie_element + " has been removed from your Watchlist!"
